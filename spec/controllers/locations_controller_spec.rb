...
describe LocationsController do
  ...
  let(:valid_attributes) { { "city_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved location as @location" do
        ...
        post :create, {:location => { "city_id" => "invalid value" }}, valid_session
        assigns(:location).should be_a_new(Location)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested location" do
        ...
        Location.any_instance.should_receive(:update).with({ "city_id" => "1" })
        put :update, {:id => location.to_param, :location => { "city_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the location as @location" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Location.any_instance.stub(:save).and_return(false)
        put :update, {:id => location.to_param, :location => { "city_id" => "invalid value" }}, valid_session
        assigns(:location).should eq(location)
      end
